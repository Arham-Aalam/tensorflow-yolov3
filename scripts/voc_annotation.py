...
def convert_voc_annotation_old(data_path, data_type, anno_path, use_difficult_bbox=True):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_annotation", default="./data/dataset/atv_train.txt")
    parser.add_argument("--test_annotation",  default="./data/dataset/atv_test.txt")
