...
__C.YOLO.DEMO_WEIGHT            = "./checkpoint/yolov3_coco.ckpt"
...
__C.TRAIN.INPUT_SIZE            = [320, 352, 384, 416, 448, 480, 512, 544, 576, 608, 800]
...
__C.TRAIN.INITIAL_WEIGHT        = "./checkpoint/yolov3_coco.ckpt"
